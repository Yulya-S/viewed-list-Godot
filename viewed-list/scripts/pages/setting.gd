...
func _on_palette_item_selected(index: int) -> void:
	var palette: Dictionary = Global.return_color_palette(index, Dark.button_pressed)
...
func _on_display_toggled(toggled_on: bool) -> void: _on_palette_item_selected(Palette.selected)
